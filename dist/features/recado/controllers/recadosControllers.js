...
var RecadoController = /** @class */ (function () {
    ...
    RecadoController.prototype.store = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, titulo, descricao, id_login, recado;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = req.body, titulo = _a.titulo, descricao = _a.descricao, id_login = _a.id_login;
                        return [4 /*yield*/, new recado_1.Recado(titulo, descricao, id_login).save()];
                    case 1:
                        recado = _b.sent();
    ...
    RecadoController.prototype.index = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, recado_1.Recado.find()];
                    case 1:
                        recados = _a.sent();
                        return [2 /*return*/, res.json(recados)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        result = _a.sent();
                        return [2 /*return*/, res.status(200).json(result.affected > 0 ? "Recado excluido" : "Não removeu")];
                }
            });
        });
    };
    RecadoController.prototype.update = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var id, _a, titulo, descricao, recado, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        id = req.params.id;
                        _a = req.body, titulo = _a.titulo, descricao = _a.descricao;
                        return [4 /*yield*/, recado_1.Recado.findOne(id)];
                    case 1:
                        recado = _b.sent();
                        if (!recado) {
