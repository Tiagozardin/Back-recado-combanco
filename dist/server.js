...
var recadosRoutes_1 = __importDefault(require("./features/recado/routes/recadosRoutes"));
var app = express_1.default();
// Receber json no corpo da Requisição
app.use(express_1.default.json());
// Vincular as rotas
var loginRoutes = new loginRoutes_1.default().init();
var recadoRoutes = new recadosRoutes_1.default().init();
